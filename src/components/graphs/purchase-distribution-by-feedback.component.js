...
class CustomActiveShapePieChart extends PureComponent {
  ...
  async componentDidMount() {
    try {
      const response = await axios.get('http://localhost:8080/api/dashboard/getPurchaseFeedback'); // Adjust URL to your API endpoint
  ...
  render() {
    ...
    return (
      <div>
        <h3>Purchase Feedback Statistics</h3>
